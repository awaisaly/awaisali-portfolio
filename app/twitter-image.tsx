    ...
    (
      <div
        style={{
          ...
          padding: 72,
          background:
            "radial-gradient(900px circle at 10% 0%, rgba(124,58,237,0.35), transparent 60%), radial-gradient(900px circle at 100% 40%, rgba(14,165,233,0.22), transparent 60%), #0b0b0b",
          color: "white",
          fontFamily:
