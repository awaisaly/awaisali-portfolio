...
export function GET() {
  ...
  const text = [
    ...
    '',
    '## Current role',
    '- Software Engineer — HATO (Jul 2026 – Present)',
    '- Developing HLM Pro, an Electron-based intelligent lighting management application for controlled-environment facilities including poultry sheds, dairy farms, and fish farms',
    '- Building real-time customer dashboards for remote monitoring, configuration, and control of HLM Pro installations',
    '- Designing GIS-powered internal dashboards for customer and lead management with map-based sales/support workflows',
    '',
    ...
    '- HATO (Jul 2026 – Present): HLM Pro Electron app, customer management dashboard, GIS-powered sales/support dashboards',
