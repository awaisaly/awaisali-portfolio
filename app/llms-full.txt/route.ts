...
export function GET() {
  ...
  const text = [
    ...
    '- Built and launched a premium knowledge workspace for connected sources, citation-backed chat, and semantic recall',
    '- Product focus: context-first workflows, visual board UX, and reusable knowledge outputs',
    '',
    '## Expertise',
    ...
    '- Knowvio (Mar 2026 – Present): creator role; product direction + UX + execution for a premium knowledge workspace',
    ...
    '',
    '## Projects (selected)',
    '- Knowvio — context-first knowledge workspace; linked sources, grounded answers, and recall',
