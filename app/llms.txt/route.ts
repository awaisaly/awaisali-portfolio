...
export function GET() {
  ...
  const text = [
    '# Awais Ali — Senior Software Engineer',
    '',
    `Website: ${siteUrl}/`,
    ...
    'Experienced collaborating with distributed teams across time zones.',
    'Experienced working in a full stack role, including Node.js backend work.',
    '',
    '## Current role',
    '- Creator at Knowvio (Mar 2026 – Present): premium knowledge workspace for citation-backed answers and semantic recall',
    '',
    '## Core skills',
    ...
    '- Knowvio — premium knowledge workspace for connected sources, grounded chat, and reusable insights',
